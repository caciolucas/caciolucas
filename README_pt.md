...
Me chamo Cácio e sou um **desenvolvedor full-stack especializado em Python (Django e FastAPI)** com experiência em outras linguagens e frameworks, como **Spring (Java)**, **Laravel (PHP)** e **Express/Knex (Node.js)**.
